...
$function modules:quicksave/private/_iterator with storage quicksaves $(node).input

# Dev mode debug
$execute if score KFrame.dev_mode KFrame matches 1 run tellraw @a {"text":"[K-Frame]","color":"aqua","bold":true,"extra":[{"text":" [Quicksave]: ","color":"green","bold":false},{"text":"Node activated: ","color":"gold","bold":false},{"text":"$(node)","color":"yellow","bold":false}]}